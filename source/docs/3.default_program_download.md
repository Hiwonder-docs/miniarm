...
Follow the instructions in "[2.Set Arduino Environment\2.2 Arduino IDE Instruction]()" to import the .zip library file in the same directory into the Arduino IDE. If the FastLED-master.zip library file has already been imported before, you can skip this step. 
...
<img  src="../_static/media/chapter_3/section_3/media/image4.png" style="width:48%" />
<img  src="../_static/media/chapter_3/section_3/media/image5.png" style="width:48%;" />
</p>



(3) If the angle between the servo and center line is less than 13°, you can adjust it through “3. Small Deviation Adjustment”. As pictured, taking servo No.2 as an example to show deviation situation.

<img class="common_img" src="../_static/media/chapter_3/section_3/media/image6.png"   />

(4) If the angle between servo and center line is greater than 13°, you can adjust it through “4. Large Deviation Adjustment”. As pictured, taking servo No.4 as an example to show deviation situation.
...
<p style="margin:0 auto 24px;width:100%">
<img  src="../_static/media/chapter_3/section_3/media/image15.png" style="width:33%" />
<img  src="../_static/media/chapter_3/section_3/media/image16.png" style="width:33%;" />
<img  src="../_static/media/chapter_3/section_3/media/image17.png" style="width:33%;" />
</p>

  

(7) After finishing installation, adjust small deviation based on “[3.2.3 Small Deviation Adjustment]()”.