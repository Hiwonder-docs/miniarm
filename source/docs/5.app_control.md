...
iOS users: search [Wonderbot](https://play.google.com/store/apps/details?id=com.Wonder.bot) in App Store and download it.

Android users : [Wonderbot](https://apps.apple.com/us/app/wonderbot-robot/id1519146341)
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image5.png" style="width:700px;"  />

**Step 3:** Open the APP **"Wonderbot"**, and tap on the icon <img src="../_static/media/chapter_5/section_1/media/image6.png" style="width:50px;"/> at the top left corner to select **"MiniArm"**.

<img class="common_img" src="../_static/media/chapter_5/section_1/media/image7.png"   />

**Step 4:** In game interface, tap on <img src="../_static/media/chapter_5/section_1/media/image8.png" style="width:50px;" /> at the top right corner, and find **"Hiwonder"** in Bluetooth list. Click on the link.
...
<table  class="docutils-nobg"  border="1">
  ...
  <tbody>
    <tr>
      <td align="center"><img src="../_static/media/chapter_5/section_1/media/image6.png" style="width:80px;"/></td>
      <td align="center">Return to the main interface to select robot type</td>
    </tr>
    <tr>
      <td align="center"><img src="../_static/media/chapter_5/section_1/media/image13.png" style="width:80px;"/></td>
      <td align="center">Open the live camera feed function</td>
    </tr>
    <tr>
      <td align="center"><img src="../_static/media/chapter_5/section_1/media/image8.png" style="width:80px;"/></td>
      <td align="center">Bluetooth connection</td>
    </tr>
    <tr>
      <td align="center"><img src="../_static/media/chapter_5/section_1/media/image15.png" style="width:80px;"/></td>
