...
(3) Double click the [**esp32_package_2.0.11_arduinome.exe**](https://docs.hiwonder.com/projects/miniArm/en/latest/docs/resources_download.html) to complete the installation.
...
<img class="common_img" src="../_static/media/chapter_8/section_2/media/image2.png"  style="width:300px;" />
...
(1) Open any program in the path of the **"8. AI Vision Game Course"**. Take **["8.5 Color Sorting"](../_static/source_code/MiniArm_color_clamp.zip)** as an example.
...
To download the firmware, please refer to "[**8.4.2 Image Postback Firmware Flashing (Optional)**](#anchor_8_4_2)" .
...
(4) Open the serial port utility tool in the path of  "[**Appendix->erial Port Utility**](https://docs.hiwonder.com/projects/miniArm/en/latest/docs/resources_download.html)".
...
(1) Open the "[**flash_download_tool_3.9.7**](https://docs.hiwonder.com/projects/miniArm/en/latest/docs/resources_download.html)" file.
...
<img class="common_img" src="../_static/media/chapter_8/section_5/media/image4.png"  style="width:300px" />
...
[MiniArm_color_clamp](../_static/source_code/MiniArm_color_clamp.zip)
...
<img class="common_img" src="../_static/media/chapter_8/section_5/media/image8.png"  style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_8/section_5/media/image10.png" style="width:600px" />

<img class="common_img" src="../_static/media/chapter_8/section_5/media/image11.png" style="width:600px" />

<p id="anchor_8_5_3_2"></p>

* **ESP32S3-Cam Program Download**

[ESP32Cam_color_clamp](../_static/source_code/ColorDetection.zip)
...
<img class="common_img" src="../_static/media/chapter_8/section_5/media/image13.png" style="width:600px" />

(4) Click the **"Tool"** in the menu bar, and select the corresponding configuration for the ESP32S3 development board.

<img class="common_img" src="../_static/media/chapter_8/section_5/media/image14.png" style="width:600px"  />
...
(1) Locate and open the "[**ESP32S3-Cam Color Recognition program\HSV\HSV.dist\HSV.exe**](https://docs.hiwonder.com/projects/miniArm/en/latest/docs/resources_download.html)" program file in the same path as this lesson.
...
<img class="common_img" src="../_static/media/chapter_8/section_5/media/image50.png" style="width:800px;" />

<img class="common_img" src="../_static/media/chapter_8/section_5/media/image51.png" style="width:800px;" />

(4) Save the HSV threshold. Locate and open the "[**ESP32S3-Cam Color Recognition Program/ColorDetection/color_detection.cpp**](../_static/source_code/ColorDetection.zip)" file in the same path as this lesson. Modify the color data to the saved HSV array. Next, refer to "[**8.5.3 Program Download -\> ESP32S3-Cam Program Download**](#anchor_8_5_3_2)" to flash the modified program into ESP32S3-Cam.
...
<img class="common_img" src="../_static/media/chapter_8/section_6/media/image3.png" style="width:300px;"  />
...
[MiniArm_color_trace](../_static/source_code/MiniArm_color_trace.zip)
...
<img class="common_img" src="../_static/media/chapter_8/section_6/media/image7.png" style="width:600px;"  />
...
<img class="common_img" src="../_static/media/chapter_8/section_6/media/image9.png" style="width:600px;" />

<img class="common_img" src="../_static/media/chapter_8/section_6/media/image10.png" style="width:600px;" />

* **ESP32S3-Cam Program Download**

[ESP32Cam_color_trace](../_static/source_code/ColorDetection.zip)
...
<img class="common_img" src="../_static/media/chapter_8/section_6/media/image12.png" style="width:600px;" />

(4) Click the **"Tool"** in the menu bar, and select the corresponding configuration for the ESP32S3 development board.

<img class="common_img" src="../_static/media/chapter_8/section_6/media/image13.png" style="width:600px;"  />
...
(3) Refer to the "[**8.6.3 Program Download -> Arduino UNO Program Download**](#anchor_8_6_3)" to flash the program into the development board. Once the flashing is completed, miniArm can track the red object.
...
<img class="common_img" src="../_static/media/chapter_8/section_7/media/image4.png"  style="width:300px;" />
...
[MiniArm_face_hello](../_static/source_code/MiniArm_face_hello.zip)
...
<img class="common_img" src="../_static/media/chapter_8/section_7/media/image8.png" style="width:600px;"  />

(4) Click <img src="../_static/media/chapter_8/section_7/media/image9.png"  /> to download the program into Arduino. Then just wait for it to complete.

<img class="common_img" src="../_static/media/chapter_8/section_7/media/image10.png" style="width:600px;" />

<img class="common_img" src="../_static/media/chapter_8/section_7/media/image11.png" style="width:600px;" />

* **ESP32S3-Cam Firmware Flashing**

[Face Detection](../_static/source_code/FaceDetection.zip)
...
<img class="common_img" src="../_static/media/chapter_8/section_7/media/image13.png" style="width:600px;" />

(4) Click the **"Tool"** in the menu bar, and select the corresponding configuration for the ESP32S3 development board.

<img class="common_img" src="../_static/media/chapter_8/section_7/media/image14.png" style="width:600px;"  />
