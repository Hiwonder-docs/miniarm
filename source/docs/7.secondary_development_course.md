...
<tr>
<td >Description</td>
<td colspan="3" >Control the RGB light color of luminous ultrasonic</td>
</tr>
<tr>
...
<td colspan="3" >
<p>(1) Ultrasound ul; (create luminous ultrasonic object)</p>
...
<tr>
<td >Description</td>
<td colspan="3" >Get measured distance of luminous ultrasonic module directly</td>
</tr>
<tr>
<td >Parameter List</td>
<td >none</td>
<td >Return Value</td>
<td >Return the distance measurement of the u16 class</td>
</tr>
<tr>
<td >Usage Instruction</td>
<td colspan="3" > 
<p>(1) Ultrasound ul; (create luminous ultrasonic object)</p>
<p>(2) ul.GetDistance(); (return the directly measured distance value, which may have interference)</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td >Description</td>
<td colspan="3" >Get the filtered measurement</td>
</tr>
<tr>
<td >Parameter List</td>
<td >none</td>
<td >Return Value</td>
<td >Return the filtered distance measurement of the int class</td>
</tr>
<tr>
<td >Usage Instruction</td>
<td colspan="3" >
<p>(1) Ultrasound ul; (create luminous ultrasonic object)</p>
<p>(2) ul.Filter(); (return the filtered value, which may remove interference)</p>
</td>
</tr>
</tbody>
</table>
...
<img class="common_img" src="../_static/media/chapter_7/section_3/media/image3.png" style="width:300px;"/>
...
[MiniArm_Ultrasound](../_static/source_code/MiniArm_Ultrasound.zip)
...
(3) Click **"Select Development Board"** option. The software will automatically test current Arduino serial port, then click to connect.
  ...
  <img class="common_img" src="../_static/media/chapter_7/section_3/media/image7.png"  style="width:600px;"/>

(4) Click <img src="../_static/media/chapter_7/section_3/media/image8.png"  /> to download the program to Arduino, then wait for download to complete.

  <img class="common_img" src="../_static/media/chapter_7/section_3/media/image9.png" style="width:600px;" />

<img class="common_img" src="../_static/media/chapter_7/section_3/media/image10.png" style="width:600px;"/>
...
<img class="common_img" src="../_static/media/chapter_7/section_3/media/image30.png"  />
...
<img class="common_img" src="../_static/media/chapter_7/section_3/media/image31.png"  />
...
<img class="common_img" src="../_static/media/chapter_7/section_4/media/image3.png"  style="300px" />
...
[MiniArm_Ultrasound_Grab](../_static/source_code/MiniArm_Ultrasound_Grab.zip)
...
<img class="common_img" src="../_static/media/chapter_7/section_4/media/image7.png"  style="600px" />
...
<img class="common_img" src="../_static/media/chapter_7/section_4/media/image9.png" style="600px" />

<img class="common_img" src="../_static/media/chapter_7/section_4/media/image10.png" style="600px" />
...
(1) Then use the  `action_ctl` object to obtain the desired value (extended_func_angles) of the servo. Combine it with the actual value (servo_angles) of the servo, and send the angle to be rotated to the servo to control servo rotating.
...
[MiniArm_touch](../_static/source_code/MiniArm_touch.zip)
...
<img class="common_img" src="../_static/media/chapter_7/section_5/media/image7.png" style="width:600px;"  />

(4) Click <img src="../_static/media/chapter_7/section_5/media/image8.png"  /> to download the program to Arduino, then wait for download to complete.

<img class="common_img" src="../_static/media/chapter_7/section_5/media/image9.png" style="width:600px;" />

<img class="common_img" src="../_static/media/chapter_7/section_5/media/image10.png" style="width:600px;" />
...
<img class="common_img" src="../_static/media/chapter_7/section_5/media/image28.png"  />
...
<img class="common_img" src="../_static/media/chapter_7/section_5/media/image29.png"  />
...
[MiniArm_IMU](../_static/source_code/MiniArm_IMU.zip)
...
(4) Click <img src="../_static/media/chapter_7/section_6/media/image8.png"  /> to download the program to Arduino, then wait for download to complete.
...
[MiniArm](../_static/source_code/MiniArm.zip)
...
<img class="common_img" src="../_static/media/chapter_7/section_7/media/image4.png" style="width:600px;"  />

(4) Click <img src="../_static/media/chapter_7/section_7/media/image5.png"  /> to download the program into Arduino. Then just wait for it to complete.

<img class="common_img" src="../_static/media/chapter_7/section_7/media/image6.png" style="width:600px;"/>

<img class="common_img" src="../_static/media/chapter_7/section_7/media/image7.png" style="width:600px;" />
...
<img class="common_img" src="../_static/media/chapter_7/section_7/media/image10.png" style="width:700px" />
